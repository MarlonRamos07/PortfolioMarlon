  ...
  return (
    <Navbar className="bg-[#121217] pt-7 sticky top-0 shadow p-4 z-50">
      ...
      <NavbarCollapse className="font-['Space_Grotesk'] text-center bg-[#B2BAE5]  md:bg-transparent font-bold mt-4">
        ...
        <NavbarLink className="md:text-black text-[0.875rem] md:hover:text-[#B2BAE5] " href="#tech">Tecnologias</NavbarLink>
        <NavbarLink className="md:text-black text-[0.875rem] md:hover:text-[#B2BAE5]" href="#projects">Projetos</NavbarLink>
        <NavbarLink className="md:text-black text-[0.875rem] mmd:hover:text-[#B2BAE5]" href="#depoimentos">Depoimentos</NavbarLink>
        <NavbarLink className="md:text-black text-[0.875rem] md:hover:text-[#B2BAE5]" href="#social">Redes Sociais</NavbarLink>
      </NavbarCollapse>
    </Navbar>
  );
}
